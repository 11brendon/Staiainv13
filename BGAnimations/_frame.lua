...
t[#t+1] = Def.Quad{
	InitCommand=function(self)
		self:xy(0,-20):halign(0):valign(0):zoomto(SCREEN_WIDTH,topFrameHeight):diffuse(getMainColor('frames')):diffusealpha(0.75)
	end;
};
...
t[#t+1] = Def.Quad{
	InitCommand=function(self)
		self:xy(0,SCREEN_HEIGHT+39):halign(0):valign(1):zoomto(SCREEN_WIDTH,bottomFrameHeight):diffuse(getMainColor('frames')):diffusealpha(0.75)
	end;
};
...
t[#t+1] = Def.Quad{
	InitCommand=function(self)
		self:xy(0,SCREEN_HEIGHT-bottomFrameHeight):halign(0):valign(0):zoomto(SCREEN_WIDTH,borderWidth):diffuse(getMainColor('highlight')):diffusealpha(0)
	end;
};
