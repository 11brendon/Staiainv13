...
t[#t+1] = Def.Quad{
	...
	InitCommand=function(self)
		self:xy(frameX,frameY):halign(1):zoomto(frameWidth,frameHeight):diffuse(getMainColor('frames')):zoom(0)
	end;
};

t[#t+1] = LoadFont("Common Large") .. {
	InitCommand=function(self)
		self:xy(frameX,frameY+5):halign(1):zoom(0):maxwidth((frameWidth-40)/0.35)
	end;
